...
databases. NoSQL databases like Redis have also been used. \\
  ...
  \item {\tt logrs} \href{https://github.com/MordecaiMalignatus/logrs}{(Github)}
    \begin{packed}
      \item Created to keep track of what was done during a day, for easy status
        ...
        location.
    \end{packed}
  \item NewNote / {\tt nn} \href{https://github.com/MordecaiMalignatus/nn}{(Github)}
    \begin{packed}
      \item Created to solve the problem of littered files that describe
        in-the-moment ideas without having any means for later evaluation. This
        instead centralises every such note taken.
    \end{packed}
